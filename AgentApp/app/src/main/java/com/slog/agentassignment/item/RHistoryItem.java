...
public class RHistoryItem extends RecyclerView.Adapter<RHistoryItem.ItemRowHolder> {
    ...
    public RHistoryItem(Context context, List<AllTransModel> dataList, int rowLayout) {
    ...
    @NonNull
    @Override
    public RHistoryItem.ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(rowLayout, parent, false);
        return new RHistoryItem.ItemRowHolder(v);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull final RHistoryItem.ItemRowHolder holder, final int position) {
