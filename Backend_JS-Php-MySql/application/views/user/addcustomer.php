                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="input" id="input" class="form-control" name="latitude" placeholder="enter latitude">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="password">Longitude</label>
                                                        <input type="input" id="longitude" class="form-control" name="longitude" placeholder="enter longitude">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="input" id="state" class="form-control" name="state" placeholder="enter state">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="password">City</label>
                                                        <input type="input" id="city" class="form-control" name="city" placeholder="enter city">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="password">zipcode</label>
                                                        <input type="input" id="zipcode" class="form-control" name="zipcode" placeholder="enter zipcode">
                                                    </div>
                                                </div>
                                                <div class="col-12">
