...
import com.slog.agentassignment.BuildConfig;
import com.slog.agentassignment.R;
import com.slog.agentassignment.activity.ChangepassActivity;
import com.slog.agentassignment.activity.EditProfileActivity;
import com.slog.agentassignment.activity.IntroActivity;
import com.slog.agentassignment.activity.PrivacyActivity;
...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rateapp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {    //Objects.requireNonNull(getActivity())
    ...
    private void aboutus() {
        ...
        htmlText = getResources().getString(R.string.about_us);
        ...
        phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                callIntent.setData(Uri.parse("tel:" + "+44 7405 937994"));
        ...
        email.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String[] TO = {"indresh.poul22@gmail.com"};
        ...
        website.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = "https://indraenterprise.com/";
