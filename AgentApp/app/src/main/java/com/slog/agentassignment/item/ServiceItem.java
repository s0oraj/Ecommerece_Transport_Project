...
import com.slog.agentassignment.activity.AllMerchantActivity;
import com.slog.agentassignment.activity.RentCarActivity;
import com.slog.agentassignment.activity.RideCarActivity;
import com.slog.agentassignment.activity.SendDetailActivity;
        ...
        switch (singleItem.getHome()) {
            ...
            case "2":
                ...
                holder.background.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent i = new Intent(mContext, SendDetailActivity.class);
                        i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        i.putExtra("FiturKey", singleItem.getIdFitur());
                        i.putExtra("job", singleItem.getJob());
                        i.putExtra("icon", singleItem.getIcon());
