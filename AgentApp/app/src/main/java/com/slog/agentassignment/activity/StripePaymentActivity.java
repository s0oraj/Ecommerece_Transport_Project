...
import com.slog.agentassignment.models.Notif;
...
public class StripePaymentActivity extends AppCompatActivity {
    ...
    private void initAction(String client) {
        mSubmitBt.setOnClickListener((View view) -> {
            PaymentMethodCreateParams.@org.jetbrains.annotations.Nullable Card card = cardInputWidget.getPaymentMethodCard();
            if (card != null) {
