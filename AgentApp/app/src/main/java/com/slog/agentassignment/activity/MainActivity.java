...
import com.slog.agentassignment.fragment.ReceivedFragment;
import com.slog.agentassignment.constants.BaseApp;
import com.slog.agentassignment.constants.Constant;
import com.slog.agentassignment.constants.VersionChecker;
import com.slog.agentassignment.fragment.EnableLlocationFragment;
import com.slog.agentassignment.fragment.HistoryFragment;
import com.slog.agentassignment.fragment.HomeFragment;
import com.slog.agentassignment.fragment.ProfileFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            menu.findItem(R.id.received).setIcon(R.drawable.ic_transaksi);
...
//                    loadFrag(favFragment, getString(R.string.menu_favourite), fragmentManager);
                    ...
                    navigationItemSelected(1);
                    item.setIcon(R.drawable.ic_transaksi_s);
                    loadFrag(receivedFragment, getString(R.string.menu_home), fragmentManager);
                    return true;
               /* case R.id.chat:
                    GPSStatus();
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
