...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>asset/app-assets/css/ourdevelops/error.css">
    <!-- END: Page CSS-->
                        ...
                        <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
                            <div class="card-content">
                                <div class="card-body text-center">
                                    <img src="<?= base_url(); ?>asset/app-assets/images/logo/404.png" class="img-fluid align-self-center" alt="branding logo">
                                    <h1 class="font-large-2 my-1">Under Development!</h1>
                                    <p class="p-2">
                                        This feature is still under development, please wait for the next update
                                    </p>
                                    <a class="btn btn-primary btn-lg mt-2" href="<?= base_url(); ?>">Back to dashboard</a>
                                </div>
                            </div>
                        </div>
                    </div>
