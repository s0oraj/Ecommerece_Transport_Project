...
import com.slog.agentassignment.models.ItemOrderModel;
...
/**
 * Created by slog team on 3/24/2019.
 */
...
//        holder.imgsend.setImageResource(Integer.parseInt(singleItem.getOrderimage()));
    }
    ...
    static class ItemRowHolder extends RecyclerView.ViewHolder {
        ...
        ItemRowHolder(View itemView) {
            super(itemView);
//            imgsend=itemView.findViewById(R.id.imagephoto);
