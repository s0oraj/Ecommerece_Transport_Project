...
import com.slog.agentassignment.activity.NewsDetailActivity;
...
public class FavouriteItem extends RecyclerView.Adapter<FavouriteItem.ItemRowHolder> {
    ...
    public FavouriteItem(Context context, List<FavouriteModel> dataList, int rowLayout) {
    ...
    public void onBindViewHolder(@NonNull final ItemRowHolder holder, final int position) {
        final FavouriteModel singleItem = dataList.get(position);
    ...
    static class ItemRowHolder extends RecyclerView.ViewHolder {
        ...
        ItemRowHolder(View itemView) {
            ...
            favourite = itemView.findViewById(R.id.received);
        }
    }
