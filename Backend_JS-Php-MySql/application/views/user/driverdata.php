                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    ...
                                    <a class="btn btn-success mb-1 text-white" href="<?= base_url(); ?>user/adddriver">
                                        ...
                                        <i class="feather icon-plus mr-1"></i>Add Driver
                                    </a>

                                    <form method="get" action="<?php echo base_url('user/driverdata?search=') ?>">
                                        <div class="row pull-right form-inline" style="justify-content: center;">
                                            <label class="mb-1 text-whit ">Agent</label>&nbsp;
                                            <select class="form-control" name="search">
                                                <option value="">Select Agent</option>
                                                <?php
                                                    foreach ($agent as $ag) {
                                                ?>
                                                <option value="<?php echo $ag['id'] ?>"><?php echo $ag['customer_fullname']; ?></option>
                                                <?php
                                                    }
                                                ?>
                                            </select>&nbsp;
                                            <button type="submit" class="btn btn-warning mr-1 mb-1" style="margin-left: 10px; margin-top: 20px;">Filter</button>
                                        </div>
                                                                                ...
                                                                                foreach ($driver as $drv) {
                                                                                    ...
                                                                                    if ($drv['status'] != 0) { ?>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <?php
                                                                                                    $agent_name = (!empty($drv['customer_fullname']))  ? $drv['customer_fullname'] : "--"
                                                                                                ?>
                                                                                                <?= $drv['customer_fullname'] ?>
