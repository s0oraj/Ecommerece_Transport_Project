...
public class IncomingOrderItem extends RecyclerView.Adapter<IncomingOrderItem.ItemRowHolder> {
    ...
    public IncomingOrderItem(Context context, List<AllTransModel> dataList, int rowLayout) {
