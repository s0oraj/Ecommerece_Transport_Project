...
public class SendActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        loginUser = BaseApp.getInstance(this).getLoginUser();
...
//        });
        ...
        if (mapboxMap != null) {
            pickUpText.setText(loginUser.getAddress() + "," + loginUser.getCity() + "," + loginUser.getState());
            Style style = mapboxMap.getStyle();
            if (style != null) {
                mapboxMap.animateCamera(CameraUpdateFactory.newCameraPosition(
                        new CameraPosition.Builder()
                                .target(new LatLng(Double.parseDouble(loginUser.getLatitude()),
                                        Double.parseDouble(loginUser.getLongitude())))
                                .zoom(15)
                                .build()), 4);
                LatLng centerPos = new LatLng(Double.parseDouble(loginUser.getLatitude()),
                        Double.parseDouble(loginUser.getLongitude()));
        ...
        if (PermissionsManager.areLocationPermissionsGranted(this) | gps_enabled && network_enabled) {
            ...
            mapboxMap.setStyle(Style.LIGHT, style -> {
                ...
                CameraPosition position = new CameraPosition.Builder()
                        .target(new LatLng(Double.parseDouble(loginUser.getLatitude()), Double.parseDouble(loginUser.getLongitude())))
                        .zoom(18)
                        .tilt(20)
                        .build();
                    ...
                    if (response.body() != null) {
                        ...
                        if (results.size() > 0) {
                            ...
                            mapboxMap.getStyle(style -> {
                                ...
                                Geocoder geocoder = new Geocoder(SendActivity.this, Locale.ENGLISH);
