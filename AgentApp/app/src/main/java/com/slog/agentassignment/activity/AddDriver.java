...
import com.slog.agentassignment.models.JobModel;
import com.slog.agentassignment.models.User;
import com.slog.agentassignment.utils.api.ServiceGenerator;
import com.slog.agentassignment.utils.api.service.DriverService;
...
public class AddDriver extends AppCompatActivity {
    ...
    TextView tanggal, countryCode, sendTo, textnotif, textnotif2;
            ...
            public void onResponse(@NonNull Call<JobResponseJson> call, @NonNull Response<JobResponseJson> response) {
                ...
                if (response.isSuccessful()) {
                    if (Objects.requireNonNull(response.body()).getMessage().equalsIgnoreCase("found")) {
                        ...
                        ArrayAdapter<String> jobSpinner = new ArrayAdapter<>(AddDriver.this, R.layout.spinner, jobdata);
...
//sendcode-----------------------
    ...
    private void setUpVerificatonCallbacks() {
        verificationCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(@NonNull String verificationId, @NonNull PhoneAuthProvider.ForceResendingToken token) {
                ...
                progresshide();
                viewFlipper.setInAnimation(AddDriver.this, R.anim.from_right);
                viewFlipper.setOutAnimation(AddDriver.this, R.anim.to_left);
    ...
    public void verifyCode(View view) {
        ...
        if (!code.equals("")) {
            ...
            notif2("Enter driver verification code!");
        }
    ...
    private void upload(final String check) {
        ...
        progressshow();
        DriverRegisterRequestJson request = new DriverRegisterRequestJson();
        ...
        request.setAgent_id(loginUser.getId());
        ...
        service.register(request).enqueue(new Callback<DriverRegisterResponseJson>() {
            @Override
            public void onResponse(@NonNull Call<DriverRegisterResponseJson> call, @NonNull Response<DriverRegisterResponseJson> response) {
                progresshide();
                if (response.isSuccessful()) {
                    if (Objects.requireNonNull(response.body()).getMessage().equalsIgnoreCase("next")) {
                        Nextbtn(viewFlipper);
//                        Toast.makeText(AddDriver.this, "Driver Added Successfully", Toast.LENGTH_SHORT).show();
//                        finish();
                    } else if (response.body().getMessage().equalsIgnoreCase("success")) {
                        finish();
                        Toast.makeText(AddDriver.this, response.body().getData(), Toast.LENGTH_SHORT).show();
                    } else {
            ...
            @Override
            public void onFailure(@NonNull Call<DriverRegisterResponseJson> call, @NonNull Throwable t) {
                progresshide();
                t.printStackTrace();
                notif("error!");
            }
