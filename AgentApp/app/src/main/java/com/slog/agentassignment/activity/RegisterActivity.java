...
import com.slog.agentassignment.models.FirebaseToken;
import com.slog.agentassignment.models.GPSTracker;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    ImageView photo, gantifoto, backbtn, backButtonverify,myloc;
    EditText phone, nama, email, password, numOne, numTwo, numThree, numFour, numFive, numSix,address,pincode,city,state;
    ...
    byte[] imageByteArray;
    Bitmap decoded;
    String dateview, disableback, latitude = "", longitude = "";
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (imageByteArray == null) {
                    ...
                    notif(getString(R.string.addempty));

                }else if (TextUtils.isEmpty(pincode.getText().toString())) {

                    notif(getString(R.string.pincodeempty));

                }else if (TextUtils.isEmpty(city.getText().toString())) {

                    notif(getString(R.string.cityempty));

                }else if (TextUtils.isEmpty(state.getText().toString())) {

                    notif(getString(R.string.stateempty));

                }else if (latitude.equalsIgnoreCase("0.00") || longitude.equalsIgnoreCase("0.00")) {

                    notif("Please Enable GPS And Search Location Again");
                    ...
                    if (latitude.length() > 0 && longitude.length() > 0
                        ...
                        try {
                            ...
                            if (addresses != null && addresses.size() > 0) {
                                ...
                                pincode.setText("" + spostalCode.trim());
...
//sendcode-----------------------
    ...
    private void upload(final String check) {
        ...
        request.setZipcode(pincode.getText().toString());
