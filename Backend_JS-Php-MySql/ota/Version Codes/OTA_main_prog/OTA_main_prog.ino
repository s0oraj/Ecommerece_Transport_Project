...
String mac;
String update_url;
String function="Monitoring_Door_Lock_System";   //Enter brief Description about Device without spaces
IPAddress myip;
String myip_str;
String my_name="ESP32_DOOR_LOOK";    //Enter the name of the device
String my_version="1.0";   //Enter the Program Version
WebServer server(80);
