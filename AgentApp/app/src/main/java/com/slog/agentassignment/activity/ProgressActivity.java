...
import com.slog.agentassignment.item.ItemOrderItem;
...
import com.slog.agentassignment.models.TransModel;
import com.slog.agentassignment.models.User;
import com.slog.agentassignment.utils.Log;
import com.slog.agentassignment.utils.NetworkManager;
...
import static com.slog.agentassignment.utils.api.service.MessagingService.BROADCAST_ORDER;
...
public class ProgressActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    LinearLayout llpayment, bottomsheet, layananall, setDestinationContainer, setPickUpContainer, llchat, lldestination, lldistance, lldetailsend, llmerchantdetail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (iddriver.equalsIgnoreCase("D0")) {
                iddriver = "";
            }
        ...
        layananall = findViewById(R.id.lllayananall);
        ...
        try {
            if (TextUtils.isEmpty(iddriver)) {
                layananall.setVisibility(View.GONE);
            } else {
                layananall.setVisibility(View.VISIBLE);
        ...
        services.detailtrans(param).enqueue(new Callback<DetailTransResponseJson>() {
            ...
            public void onResponse(@NonNull Call<DetailTransResponseJson> call, @NonNull Response<DetailTransResponseJson> responsedata) {
                if (responsedata.isSuccessful()) {
                    ...
                    Log.d("designedFitur", "" + designedFitur);
                    ...
                    if (transaksi.status == 4 && transaksi.getRate().isEmpty() && !TextUtils.isEmpty(iddriver)) {
                    ...
                    Log.d("designedFitur.getHome()",""+designedFitur.getHome());;
                    ...
                    try {
                        pickUpText.setText(transaksi.getAlamatAsal());
                        destinationText.setText(transaksi.getAlamatTujuan());
                    } catch (NullPointerException e) {
                    } catch (Exception e) {
                    }

                    try {
                        Utility.currencyTXT(diskon, transaksi.getKreditPromo(), ProgressActivity.this);
                        Utility.currencyTXT(priceText, String.valueOf(transaksi.getBiaya_akhir()), ProgressActivity.this);
                    } catch (NullPointerException e) {
                    } catch (Exception e) {
                    }
