                    ...
                    <div class="col-md-6 col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <?= form_open_multipart('wallet/addwithdrawdata'); ?>
                                    <form class="form form-vertical">
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="wallet_account">Bank Account</label>
                                                        <input type="text" class="form-control" id="wallet_account" name="wallet_account" placeholder="enter Bank Account">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="holder_name">Account Username</label>
                                                        <input type="text" class="form-control" id="holder_name" name="holder_name" placeholder="enter Account Username">
                                                    </div>
                                                </div>
                                                <div class="col-12">
